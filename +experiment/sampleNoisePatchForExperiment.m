function [stimuli] = sampleNoisePatchForExperiment(ImgStats, targetKeyStr, binIndex, binContrast, nTrials, nLevels, nBlocks, sampleMethod)
...
for iTrials = 1:nTrials
    for iLevels = 1:nLevels
        for iBlocks = 1:nBlocks           
            ...
            nPatch = nPatch ./ std(nPatch(:)) .* maskContrast .* floor((2^16 - 1)/2) + floor((2^16 - 1)/2);
