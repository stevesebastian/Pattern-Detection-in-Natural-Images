...
<<<<<<< HEAD
edfFile = [num2str(SessionSettings.currentBin),num2str(SessionSettings.currentSession),...
    num2str(SessionSettings.targetTypeStr(1)), SessionSettings.subjectStr, '.edf'];
